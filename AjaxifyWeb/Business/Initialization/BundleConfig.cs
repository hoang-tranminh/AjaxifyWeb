...
namespace AjaxifyWeb.Business.Initialization
{
    [InitializableModule]
    public class BundleConfig : IInitializableModule
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/js").Include(
                        ...
                        "~/Static/js/jquery-scrollto.js",//required by ajaxify plugin 
                        "~/Static/js/jquery.history.js", //required by ajaxify plugin
                        "~/Static/js/ajaxify-html5.js"
                        //"~/Static/js/ajaxify-html5-original.js"
                        ));
